-- =====================================================
-- CRIAR TABELA ASSINATURAS_USUARIOS - CORRIGIDO
-- =====================================================
...
-- Verificar se a tabela planos existe e sua estrutura
SELECT 
    column_name,
    data_type,
    is_nullable
FROM information_schema.columns 
WHERE table_name = 'planos' AND column_name = 'id';

-- Criar tabela assinaturas_usuarios com tipos corretos
